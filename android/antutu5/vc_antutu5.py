...
multitask_score_text = multitask_score.getText()
runtime_score_text = runtime_score.getText()
ram_operation_text = ram_operation_score.getText()
ram_speed_score_text = ram_speed_score.getText()
cpu_multi_integer_text = cpu_multi_integer_score.getText()
cpu_multi_float_text = cpu_multi_float_point_score.getText()
cpu_single_integer_text = cpu_single_integer_score.getText()
cpu_single_float_text = cpu_single_float_point_score.getText()
twod_graphics_text = twod_graphics_score.getText()
threed_graphics_text = threed_graphics_score.getText().split()[1]
storage_io_text = storage_io_score.getText()
database_io_text = database_io_score.getText()
total_score = int(multitask_score_text) + \
                int(runtime_score_text) + \
                int(ram_operation_text) + \
                int(ram_speed_score_text) + \
                int(cpu_multi_integer_text) + \
                int(cpu_multi_float_text) + \
                int(cpu_single_integer_text) + \
                int(cpu_single_float_text) + \
                int(twod_graphics_text) + \
                int(threed_graphics_text) + \
                int(storage_io_text) + \
                int(database_io_text)


# psw0523 debugging
# print(['lava-test-case', '"AnTuTu 5.0 Alpha Total Score"', '--result', 'pass', '--measurement', str(total_score)])
...
call(['lava-test-case', '"AnTuTu 5.0 Alpha Total Score"', '--result', 'pass', '--measurement', str(total_score)])
call(['lava-test-case', 'AnTuTu 5.0 Alpha UX Multitask Score', '--result', 'pass', '--measurement', multitask_score_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha UX Runtime Score', '--result', 'pass', '--measurement', runtime_score_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha RAM Operation Score', '--result', 'pass', '--measurement', ram_operation_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha RAM Speed Score', '--result', 'pass', '--measurement', ram_speed_score_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha Multi Core CPU Integer Score', '--result', 'pass', '--measurement', cpu_multi_integer_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha Multi Core CPU Float-Point Score', '--result', 'pass', '--measurement', cpu_multi_float_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha Single Thread CPU Integer Score', '--result', 'pass', '--measurement', cpu_single_integer_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha Single Thread CPU Float-Point Score', '--result', 'pass', '--measurement', cpu_single_float_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha GPU 2D Graphics Score', '--result', 'pass', '--measurement', twod_graphics_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha GPU 3D Graphics Score', '--result', 'pass', '--measurement', threed_graphics_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha IO Storage IO Score', '--result', 'pass', '--measurement', storage_io_text])
call(['lava-test-case', 'AnTuTu 5.0 Alpha IO Database IO Score', '--result', 'pass', '--measurement', database_io_text])
