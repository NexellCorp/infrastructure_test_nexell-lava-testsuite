...
#print("multitask_score : "), multitask_score.getText()
#print("runtime_score : "), call(['lava-test-case', '"AnTuTu 5.0 Alpha UX Runtime Score"', '--result', 'pass', '--measurement', runtime_score.getText()])
'''
time.sleep(3)
